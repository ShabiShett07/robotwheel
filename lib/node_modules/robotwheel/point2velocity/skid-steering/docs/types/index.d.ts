...
*/
declare function skid_steering( radius: number, wheelbase: number, x0: number, y0: number, psi0: number, x1: number, y1: number, psi1: number, time: number ): Array<number>;


// EXPORTS //

export = skid_steering;
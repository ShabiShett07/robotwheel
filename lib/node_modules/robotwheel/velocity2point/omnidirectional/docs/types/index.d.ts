/**
* Computes the wheel velocities of omni directional wheeled robots given final orientation of the robot.
*
...
*/
declare function omni_directional( radius: number, wheelbase: number, x0: number, y0: number, psi0: number, wheel_velocity_1: number, wheel_velocity_2: number, wheel_velocity_3: number, time: number ): Array<number>;


// EXPORTS //

export = omni_directional;
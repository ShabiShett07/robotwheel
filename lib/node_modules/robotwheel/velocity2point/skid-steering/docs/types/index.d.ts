/**
* Interface describing `skid_steering`.
*/
interface Routine {
    /**
    ...
    */
    ( radius: number, wheelbase: number, x0: number, y0: number, psi0: number, wheel_velocity_1: number,  wheel_velocity_2: number,  wheel_velocity_3: number,  wheel_velocity_4: number, time: number ): Float64Array;
}
...
* // z => <Float64Array>[ 0.5, 0.0, 0.0 ]
*/
declare var skid_steering: Routine;

...
interface Routine {
    ...
    */
    ( radius: number, wheelbase: number, trackwidth: number, x0: number, y0: number, psi0: number, wheel_velocity_1: number, wheel_velocity_2: number, wheel_velocity_3: number, wheel_velocity_4: number, time: number ): Float64Array;
}

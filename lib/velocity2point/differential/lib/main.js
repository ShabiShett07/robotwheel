...
// MAIN //
function differential(radius, wheelbase, x0, y0, psi0, wheel_velocity_1, wheel_velocity_2, time) {
    var state_vector;
    ...
    wheel_velocity_matrix = new Float64Array( [ wheel_velocity_1, wheel_velocity_2 ] );

...
// MAIN //
function mecanum_wheeled(radius, wheelbase, trackwidth, x0, y0, psi0, wheel_velocity_1, wheel_velocity_2, wheel_velocity_3, wheel_velocity_4, time) {
    var state_vector;
    ...
    dscal( 3, radius / 4, initial_state_vector, 1 );
